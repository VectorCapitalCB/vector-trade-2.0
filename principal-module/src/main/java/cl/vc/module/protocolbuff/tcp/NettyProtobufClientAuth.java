...
@Slf4j
public class NettyProtobufClientAuth extends Thread implements InterfaceTcp {
    ...
    private boolean isCtopped = false;
    ...
    public NettyProtobufClientAuth(String localhost, ActorRef receiverActor, String path, String detination, NotificationMessage.Component  component) throws Exception {
    ...
    public NettyProtobufClientAuth(String host, ActorRef receiverActor, String path, String detination, NotificationMessage.Component  component,
    ...
    public NettyProtobufClientAuth(String host, ActorRef receiverActor, String path, String detination, NotificationMessage.Component  component, Boolean islog) throws Exception {
        String[] parts = host.split(":", 2);
        assert parts.length == 2;
        this.hostname = parts[0];
        this.port = Integer.parseInt(parts[1]);
    ...
    public NettyProtobufClientAuth(String host, ActorRef receiverActor, String path, String detination,
    ...
    public void run() {
        ...
        while (!isCtopped) {
            ...
            try {
                ...
                NettyProtobufClientAuth thisClient = this;
    ...
    public static void main(String[] arg){
        try {
            ...
            NettyProtobufClientAuth nettyProtobufClient =
                    new NettyProtobufClientAuth("localhost:8011", actorRef, "logs/client", "XSGO",
                            NotificationMessage.Component.XRO, true, "service-vector-trade");
    ...
    public class NettyProtoHandler extends SimpleChannelInboundHandler<ByteBuf> {
        ...
        private final NettyProtobufClientAuth clientThread;

        public NettyProtoHandler(NettyProtobufClientAuth clientThread) {
